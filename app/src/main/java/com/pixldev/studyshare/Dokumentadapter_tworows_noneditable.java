...
public class Dokumentadapter_tworows_noneditable extends RecyclerView.Adapter<Dokumentadapter_tworows_noneditable.ViewHolder> {

    private final ArrayList<Dokumentmodel> dokumentModelArrayList;
    private final Context context;

    // Constructor
    public Dokumentadapter_tworows_noneditable(Context context, ArrayList<Dokumentmodel> dokumentModelArrayList) {
    ...
    @NonNull
    @Override
    public Dokumentadapter_tworows_noneditable.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_dokument_tworows_noneditable_recyclerview, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Dokumentadapter_tworows_noneditable.ViewHolder holder, int position) {
