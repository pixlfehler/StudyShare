...
public class Dokumenteadapterlabary extends RecyclerView.Adapter<Dokumenteadapterlabary.ViewHolder> {

    private final ArrayList<Dokumentmodel> dokumentModelArrayList;
    private final Context context;

    // Constructor
    public Dokumenteadapterlabary(Context context, ArrayList<Dokumentmodel> dokumentModelArrayList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Dokumenteadapterlabary.ViewHolder holder, int position) {
